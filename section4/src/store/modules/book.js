...
export const selectBook = (id) => ({ type: SELECT_BOOK, payload: id });
  ...
  list: [
    {
      ...
      publisher: '다빈치books',
      release: '2021.09',
      image: 'https://image.yes24.com/goods/103412179/S',
      description:
      ...
      link: 'https://www.yes24.com/Product/Goods/103412179',
    },
    {
      id: Date.now() + 2,
      ...
      publisher: '이지스퍼블리싱',
      release: '2019.06',
      image: 'https://image.yes24.com/goods/74419916/S',
      description:
      ...
      link: 'https://www.yes24.com/Product/Goods/74419916',
    },
    {
      id: Date.now() + 3,
      ...
      publisher: '한빛미디어',
      release: '2020.12',
      image: 'https://image.yes24.com/goods/96024871/S',
      description:
      ...
      link: 'https://www.yes24.com/Product/Goods/96024871',
    },
    {
      id: Date.now() + 4,
      ...
      publisher: '티더블유아이지',
      release: '2020.07',
      image: 'https://image.yes24.com/goods/91165789/S',
      description:
      ...
      link: 'https://www.yes24.com/Product/Goods/91165789',
    },
    {
      id: Date.now() + 5,
    ...
    },
    {
      ...
      link: 'https://www.yes24.com/Product/Goods/78586788',
    },
  ],
  selectedBook: null,
};
...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    case SELECT_BOOK: {
      return {
        ...state,
        selectedBook: state.list.filter((book) => book.id === action.payload)[0],
      };
    }
    default: {
      return state;
